 ...
 * @return array
 */
function action_editer_produit($arg=null) {
	...
	if ($id_produit > 0) $err = produit_vendu_modifier($id_produit);
 ...
 * @return string
 */
function produit_vendu_modifier($id_produit, $set=null) {
	$err = '';
	...
	$err = produit_vendu_instituer($id_produit, $c);
 ...
 * @return string
 */
function produit_vendu_instituer($id_produit, $c, $calcul_rub=true){
	include_spip('inc/autoriser');
